...
docker container run -p 8079:8079 -d --name server_container --restart always --env-file .env -v /var/log/spring_boot:/var/log/spring-boot -v /var/log/nginx:/var/log/nginx -v /home/app/sample:/java-server/sample java-server:latest