...
class EmartCrawler(NoLinkCrawler):
    ...
    def search_option_setting(self) -> None:
        ...
        region_locators = self.page.locator("#container > div > div.filter.active > div.filter-wrap > div.ft-cont > div.ft-branch > ul > li").all()
        ...
        branch_locators = self.page.locator(f"#container > div > div.filter.active > div.filter-wrap > div.ft-cont > div.ft-branch.active > ul > li.ft-accor-item.active > div.ft-accor-cont.scroll > ul > li").all()
        for branch_locator in branch_locators:
            branch_name: str = branch_locator.locator("label").inner_text()
